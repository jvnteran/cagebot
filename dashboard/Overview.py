...
from components.styles import configure_page, inject_styles, eyebrow, stat_card, section_title
...
st.markdown("<h2 style='margin-bottom:0;font-size:28px;'>UFC Fight Prediction, Measured Honestly</h2>", unsafe_allow_html=True)
st.markdown(
    "<p style='color:#8e8e96;font-size:13px;margin-top:8px;line-height:1.7;max-width:720px;'>"
    "A machine learning model has predicted every UFC fight since December 2025. Predictions "
    "are recorded before each event and never revised. This dashboard is the analytics layer "
    "over that record — what the model got right, what it got wrong, and how it prices "
    "against the betting market.</p>",
...
st.markdown(
    ...
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Market odds</div>"
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Fight records</div>"
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Career history</div>"
    ...
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>private engine</div>"
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Recorded pre-event</div>"
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Human review layer</div>"
    "<div style='position:absolute;right:-7px;top:36px;width:14px;height:14px;"
    "background:#060606;border:1px solid #dc2626;border-radius:50%;display:grid;"
    "place-items:center;z-index:2;color:#dc2626;font-family:JetBrains Mono;font-size:10px;'>→</div>"
    "</div>"
    ...
    "<div style='padding:18px;border-right:1px solid #1c1c20;position:relative;'>"
    "<div style='font-family:Chakra Petch,sans-serif;font-size:12px;letter-spacing:0.18em;"
    "text-transform:uppercase;color:#f5f5f5;margin-bottom:12px;'>Analytics ETL</div>"
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Idempotent loaders</div>"
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Name normalization</div>"
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Atomic upserts</div>"
    "<div style='position:absolute;right:-7px;top:36px;width:14px;height:14px;"
    "background:#060606;border:1px solid #dc2626;border-radius:50%;display:grid;"
    "place-items:center;z-index:2;color:#dc2626;font-family:JetBrains Mono;font-size:10px;'>→</div>"
    "</div>"
    ...
    "<div style='font-family:JetBrains Mono,monospace;font-size:10px;color:#c8c8cf;"
    "padding:5px 0 5px 12px;border-left:1px solid #26262c;'>Sanitized views</div>"
    "</div>"
    "</div>",
    unsafe_allow_html=True,
)
...
with c2:
    stat_card("model only", f"{model_pct}%",
              f"{int(m.model_correct)} / {int(m.decided)} · no human input")
with c3:
...
st.markdown(
    ...
    "<p style='font-size:13px;color:#c8c8cf;line-height:1.85;margin:0 0 12px;'>"
    "Predictions come from a model trained on fight history, career "
    "trajectory and market pricing. A <span style='color:#f5f5f5;font-weight:500;'>"
    "human-in-the-loop review layer</span> then examines each prediction and occasionally "
    "reverses one, on the fights where statistical patterns miss context that only domain "
    "knowledge catches. Every prediction is written down before the event and never "
    "revised afterwards.</p>"
